...
$host = 'localhost'; // Generalmente, Hostinger utiliza 'localhost'
$user = 'u623182981_contador_user'; // Nombre de usuario de la base de datos
$password = 'Eisenholz2024'; // Contraseña configurada
$dbname = 'u623182981_contador_db'; // Nombre de la base de datos
